    ...
    <div className="container mx-auto px-4 py-16 mt-[50px]">
      <div className="space-y-12 px-6">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          ...
          alignment through rigid fusion, prevent further deformity and
        ...
        <div className="space-y-10">
          ...
          <div className="bg-white rounded-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              <span className="font-semibold">Ans:</span> All spinal deformities
              involve deviation of the curve or rotation of the spine.
            </p>
          </div>
          ...
          <div className="lg:flex">
            <div>
              ...
              {/* Risk Factors */}
              <div className="bg-white rounded-md">
                <h2 className="text-[#273c76] font-semibold text-xl mb-4">
                ...
                <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed">
                  ...
                  <li>
                    There are a few known genetic/Congenital conditions that may
                    put someone at risk of developing scoliosis, including
          ...
          <div className="bg-white rounded-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Symptoms differ, depending on the type of deformity. They may take
              the form of:
            </p>
            <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed">
              <li>
                <span className="font-semibold">Pain:</span> For scoliosis, this
                pain may occur in the upper spine and the ribs.
              </li>
              <li>
              ...
              <li>
                ...
                may be noticeable. In scoliosis, one shoulder blade, or hip, may
          ...
          <div className="bg-white rounded-md">
            ...
            <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed">
              ...
              <li>
                X-rays of the spine- which will be x rays whole spine include
                both shoulder and and proximal thighs
              </li>
              <li>
                Magnetic resonance imaging (MRI) – usually to rule out any
                underlying spinal cord pathology and if any then has to address
                before deformity correction
              </li>
              <li>
                Computerized tomography (CT) scans, in order to analyze the
                internal bony structure of the spine and for surgical planning
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mt-4">
              Intervention may not be needed if the deformity is not progressing
              and the symptoms aren’t a problem for the patient. In these cases,
              specialists will monitor the curve and treat when necessary. There
              are also several methods of physical therapies to treat spinal
              deformities by helping to reorient the spine and slow down the
          ...
          <div className="bg-white rounded-md">
            ...
            {/* <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Spinal surgery may be necessary when:
            </p> */}
            <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mt-4">
              ...
              bones in better positions.Patients can expect to recover from this
          ...
          <div className="bg-white rounded-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              children with spinal deformities, nonsurgical treatments are often
              chosen since children's bones are still developing. A brace, for
              example, can direct a child’s growing spine into the right
              alignment. In adults, the same treatment would be less effective
              because the spine is already rigid in its position.
            </p>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              nonsurgical option for adults. It will not change the position of
              the spine, but it may ease pressure and pain. Orthotics (shoe
