...
const Header = () => {
  ...
  return (
    ...
    >
      <header className="flex justify-between items-center px-6 lg:px-16">
        <div className="relative flex items-center">
          {/* Logo */}
          <div className="lg:w-[300px] w-[200px] lg:px-4">
            <Link
              href="/"
                ...
                <li key={menuItem.id} className="group relative">
                  {menuItem.path ? (
                    ...
                    <>
                      ...
                      <div
                        className={`submenu -left-16 lg:ml-0 ml-4 rounded-sm bg-white transition-[top] duration-300 lg:absolute lg:top-[110%] lg:w-[650px] lg:shadow-lg ${
                          openIndex === index
                            ? "lg:grid lg:grid-cols-2 p-4 gap-5"
                            : "hidden"
                        }`}
                      >
        ...
        <div className="flex justify-end bg-[#07a496] w-[300px] lg:w-[300px] lg:px-4 rounded-full">
          <Link
