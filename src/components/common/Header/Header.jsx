                ...
                >
                  {menuItem.path ? (
                    ...
                    <>
                      ...
                      <div
                        className={`submenu relative left-0 top-full lg:ml-0 pl-4 rounded-sm transition-[top] duration-300 lg:absolute lg:top-[102%] lg:w-[250px] lg:p-4 bg-white lg:shadow-lg ${
                          ...
                          >
                            {submenuItem.path ? (
                              ...
                              <>
                                ...
                                <div
                                  className={`lg:ml-[225px] rounded-sm bg-white lg:px-3 lg:py-2 lg:-mt-6 ml-4 transition-[top] duration-300 lg:absolute lg:w-[250px] lg:shadow-lg ${
